...
<div>
  ...
  <tbody>
    ...
    <tr data-toggle="modal" data-id="{{$expense->expense_id}}" data-user_id="{{$expense->user_id}}" data-categoryid="{{$expense->category_id}}" data-amount="{{$expense->amount}}"  data-entry ="{{$expense->entry}}" data-categoryname="{{$expense->category->name}}" data-target="#editexpense">
  ...
  <div class="modal-dialog modal-edit" style="width:1250px;" role="document">
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form method="post" action="/newuserexpense">
        @csrf
  ...
  <div class="modal-dialog modal-edit" style="width:1250px;" role="document">
   ...
   <div class="panel panel-default">
    <div class="panel-heading">
       ...
       <form method="post" action="/userupdateexpense">
        @csrf
        ...
        <label>Amount</label>
        <input type="number" name="amount" id="amount" min="1" max="10000" class="form-control" required >
      ...
      <div class="modal-footer">
       <a href="/userdeleteexpense" id="deletemethod" class="btn btn-danger"  style="margin-right: 220px;">Delete</a>
        <button type="button"   class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
$('#editexpense').on('show.bs.modal', function (event){
  ...
  modal.find('.modal-body #expense_id').val(id2);
